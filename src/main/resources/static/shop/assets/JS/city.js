...
selectProvince.addEventListener("change", function() {
    var selectedValue = selectProvince.value;
    var cities = province[selectedValue].city;
    ...
    var selectedProvinceValue = selectProvince.value;
    var selectedCityValue = selectCity.value;
    var areas = province[selectedProvinceValue].city[selectedCityValue].districtAndCounty;
...
function getSelectedTexts(event) {
  ...
  var selectedProvinceText = selectedProvince.options[selectedProvince.selectedIndex].text;
  var selectedCityText = selectedCity.options[selectedCity.selectedIndex].text;
  var selectedAreaText = selectedArea.options[selectedArea.selectedIndex].text;
  console.log(selectedProvinceText)
  console.log(selectedCityText)
  console.log(selectedAreaText)
  // 将文本内容设置到隐藏字段中
  document.getElementById("selectedProvinceText").value = selectedProvinceText;
  document.getElementById("selectedCityText").value = selectedCityText;
  document.getElementById("selectedAreaText").value = selectedAreaText;
